...
static const double  DSR_TOFFSET       = 3.125;
static const double  FIRING_TOFFSET    = 50;
...
private:
    ...
    //lyh modified 7
    std::vector<lslidar_c16_msgs::LslidarC16Point> sweep_point_cloud;
...
POINT_CLOUD_REGISTER_POINT_STRUCT(lslidar_c16_decoder::PointXYZIT_LYH,
                                  (float, x, x)(float, y, y)(float, z, z)(
                                      uint8_t, intensity,
